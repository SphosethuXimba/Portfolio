...
public class BankingApp {
    ...
    // this method takes in the accountID from the user as a parameter and returns a boolean value (true or false)
    public static boolean checkAccountID(String accountID)
    {
        ...
        {return false;}
    }// end checkAccountID method
    
     //this method takes in the password from the user as a parameter and returns a boolean value (true or false)
    public static boolean checkPassword(String password)
    {
        ...
        // if password contains a digit and a space >> then return true
    ...
    // >> it takes in the number of transactions as a parameter >> it then creates an instance of the transaction 
